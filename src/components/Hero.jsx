                ...
                <div className='flex flex-col md:flex-row md:mt-1 mt-16 justify-center container mx-auto'>
                    ...
                    <div className='flex md:flex-row flex-col justify-center items-center md:w-1/2'>
                        <div className='md:flex md:flex-col text-gray-100 gap-7 drop-shadow-md px-16 items-center justify-center hidden'>
                            ...
                            >
                                <a href='https://www.linkedin.com/in/rajesh13698' target="_blank" className='btn-icons'><FaLinkedin size={30} /></a>
                            </motion.div>
                            <motion.div
                                ref={ref}
                                initial={{ opacity: 0, y: 100 }}
                            ...
                            >
                                <a href='https://github.com/rajeshrio9885' target="_blank" className='btn-icons'><AiOutlineGithub size={30} /></a>
                            </motion.div>
                            <motion.div
                                ref={ref}
                                initial={{ opacity: 0, y: 100 }}
                            ...
                            >
                                <a href='https://drive.google.com/file/d/16b1eRxkIs_V2Pef5qCDaaxAb-Y1nNqCn/view' target="_blank" className='btn-icons'><BsFillSuitcaseLgFill size={30} /></a>
                            </motion.div>
                        </div>
                        ...
                        <div className='flex flex-col mt-10 mb-10'>
                            <div className='text-white font-list-font drop-shadow-md w-max'>
                                ...
                                <p className='md:text-4xl text-xl mt-3'>
                                    I am a <span className='text-teal-300 md:text-4xl text-2xl font-extrabold'>Fullstack</span> Developer
                                </p>
                            </div>
                            ...
                            <div className='flex gap-5 mt-7 text-white drop-shadow-md md:hidden'>
                                ...
                                <motion.div
                                    ...
                                    transition={{ type: "tween", stiffness: 400, damping: 10, duration: 0.5, delay: 0.3 }}
                                >
                                    <a href='https://drive.google.com/file/d/16b1eRxkIs_V2Pef5qCDaaxAb-Y1nNqCn/view' target="_blank" className='btn-icons'><BsFillSuitcaseLgFill size={25} /></a>
                                </motion.div>
                                ...
                                <div className='flex gap-2 items-center font-bold'>
                                    ...
                                    >
                                        <a
                                            ...
                                            href="https://drive.google.com/file/d/1gHMYkc7pkmoVSaapdywRtiRtD27qdt0F/view"
                                            target='_blank'
                                        >
